...
get_eligibility <- function(criteria, type = "inclusion"){
  ...
  split_Criteria = str_split(criteria, pattern = "Exclusion Criteria:")
  text = str_remove(split_Criteria[[1]][n], "Inclusion Criteria:")
  text = str_replace_all(text, pattern = "<br><br>", "<br>")
  text = str_replace_all(text, pattern = "<br>", "<br> - ")
...
test = data$EligibilityCriteria[1]

study <- function(data, i, inclusion=inclusion, exlcusion=exclusion) {
    ...
    div(id=NCT_ID,
      ...
      div(class = "contact",
          ...
          tibble(Name = contact_name,
                 Phone = contact_phone,
                 Email = contact_email)) %>%
            kableExtra::scroll_box(width = "90%", box_css = "border: 0px;")
      )),
